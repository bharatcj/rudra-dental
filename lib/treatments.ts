...
export const TREATMENTS: Treatment[] = [
  {
    ...
    icon: "rct",
    image: "/gallery/operatory.jpg",
    imageAlt: "Operatory at Rudra Dental where root canal treatment is carried out",
    intro: [
  ...
  },
  {
    ...
    icon: "implant",
    image: "/gallery/operatory-two.jpg",
    imageAlt: "Second operatory at Rudra Dental used for implant placement",
    intro: [
  ...
  },
  {
    ...
    imageAlt: "Reception and waiting lounge at Rudra Dental Anakaputhur",
    intro: [
  ...
  },
  {
    ...
    imageAlt: "Treatment corridor leading to the operatories at Rudra Dental",
    intro: [
  ...
  },
  {
    ...
    icon: "laser",
    image: "/gallery/logo-panel.jpg",
    imageAlt: "Rudra Dental treatment room signage",
    intro: [
  ...
  },
  {
    ...
    icon: "kids",
    image: "/gallery/waiting-lounge.jpg",
    imageAlt: "Waiting lounge at Rudra Dental where families wait",
    intro: [
  ...
  },
  {
    ...
    icon: "fullmouth",
    image: "/gallery/logo-wall.jpg",
    imageAlt: "The Rudra Dental reception lounge in Anakaputhur",
    intro: [
